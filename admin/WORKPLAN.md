...
- [✅] M1.T1 — Download LA Open Data crime dataset (Maddy)
- [✅] M1.T2 — Initial exploratory data analysis (Ashley)
- [✅] M1.T3 — Identify crime types for prediction (Team)
- [✅] M1.T4 — Determine specific modeling techniques (Team)
